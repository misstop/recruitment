...
class Candidate(models.Model):
    ...
    first_result = models.CharField(max_length=256, choices=FRIST_INTERVIEW_RESULT_TYPE, blank=True,
                                    verbose_name=u'初试结果')
    ...
    first_remark = models.CharField(max_length=256, blank=True, verbose_name=u'初试备注')
    ...
    second_remark = models.CharField(max_length=256, blank=True, verbose_name=u'专业复试备注')
