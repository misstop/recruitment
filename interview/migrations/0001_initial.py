# Generated by Django 3.2 on 2021-04-18 09:06
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_remark', models.CharField(blank=True, max_length=256, verbose_name='初试备注')),
                ...
                ('second_remark', models.CharField(blank=True, max_length=256, verbose_name='专业复试备注')),
                ('hr_score', models.CharField(blank=True, choices=[('S', 'S'), ('A', 'A'), ('B', 'B')], max_length=10, verbose_name='HR复试综合等级')),
                ('hr_responsibility', models.CharField(blank=True, choices=[('S', 'S'), ('A', 'A'), ('B', 'B')], max_length=10, verbose_name='HR责任心')),
                ('hr_communication_ability', models.CharField(blank=True, choices=[('S', 'S'), ('A', 'A'), ('B', 'B')], max_length=10, verbose_name='HR坦诚沟通')),
                ('hr_logic_ability', models.CharField(blank=True, choices=[('S', 'S'), ('A', 'A'), ('B', 'B')], max_length=10, verbose_name='HR逻辑思维')),
                ('hr_potential', models.CharField(blank=True, choices=[('S', 'S'), ('A', 'A'), ('B', 'B')], max_length=10, verbose_name='HR发展潜力')),
                ('hr_stability', models.CharField(blank=True, choices=[('S', 'S'), ('A', 'A'), ('B', 'B')], max_length=10, verbose_name='HR稳定性')),
